...
```{r, setup, echo=FALSE, include=FALSE}
  gc()
  rm(list = ls())
  knitr::opts_knit$set(root.dir = '/Users/joanacima/Documents/GitHub/R_Training/EDA/')
  library(tidyverse)
  library(haven)
  library(readxl)
...
# Cross-Tabulations (row proportions)
ctable(x = sal$rank, 
       y = sal$sex, 
       prop = "r")

# Cross-Tabulations (column proportions)
ctable(x = sal$rank, 
       y = sal$sex, 
       prop = "c")
...
(df_sal_stats_by_sex <- stby(data      = sal, 
                               INDICES   = sal$sex, 
                               FUN       = descr, 
                               stats     = "common", 
                               transpose = FALSE))
