...
rm(list = ls())
setwd("/Users/miguelportela/Documents/GitHub/R_Training/md_examples")

# setwd("C:/Users/mangelo.EEG/Documents/GitHub/R_Training/md_examples")
...
r1 <- lm(data = nls2,ln_wage ~ tenure)
r2 <- lm(data=nls2,ln_wage ~ tenure + union)
stargazer(r1,r2,title = "First set of regressions",column.labels = c("M1", "M2"),label = "regressions",table.placement = "ht",notes.append = FALSE,notes.align="l",notes="Standard errors in parentheses.",header = FALSE)
betas<-coef(r2)
