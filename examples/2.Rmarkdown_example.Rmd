...
stargazer(M1,M2,title = "First set of regressions",column.labels = c("M1", "M2"),label = "regressions",table.placement = "ht",notes.append = FALSE,notes.align="l",notes="Standard errors in parentheses.",header = FALSE)
betas<-coef(M2)
