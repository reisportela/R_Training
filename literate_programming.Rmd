...
# Install pandoc
 ...
 0. Show the end of the game
 1. Install Pandoc
 2. Write the first Markdown file
 3. Open the Terminal and execute the pandoc command
 3. Create automatically the first markdown file -- EXPLORE THIS ITEM
...
R Markdown cheetsheet: check the Meny Help
